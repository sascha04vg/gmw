...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('treblePath').addEventListener('animationend', function(event) {
        if (event.animationName === 'fadeOut') {
            const overlay = document.getElementById('treble__overlay');
            overlay.classList.add('overlayfadeOut');
            
            document.getElementById('treblePath').addEventListener('animationend', function() {
